...
<link href="css/pages/8.css" rel="stylesheet">
<script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>

<script>
	$(function() {
		$('.calendar .date').daterangepicker({
			opens: 'left',
			locale: {
		      format: 'DD.MM.YY'
		    }
...
<div class="container">
	<div class="row">
		<div class="col">
			<div class="header">Мой счет - Поступления</div>
		</div>
		<div class="col">
			<div class="calendar">
				<div class="date-wrap">
	...
	<div class="main">
		<div class="row">
			...
			<div class="col">
				<div class="item">
					<div class="title">Общая сумма реферальных чеков</div>
					<div class="price">543 642 ₽</div>
				</div>
			</div>
			<div class="col">
				<div class="item">
					<div class="title">Всего начислено бонусов</div>
					<div class="price">143 236 ₽</div>
				</div>
			</div>
			<div class="col">
				<div class="item">
					<div class="title">Всего вывели</div>
					<div class="price">143 236 ₽</div>
				</div>
			</div>
		</div>
		...
		<table>
			...
			<tbody>
				<?php for($i = 3; $i <= 11; $i++) { ?>
					<tr>
						<td>1 апреля 2022</td>
						<td><span>Instagram</span><span>Шапка профиля @username</span></td>
						<td>
							<div class="method">
...
<script>
	$('.menu a:contains("Поступления")').addClass('active');
	$('.sidebar a:contains("Поступления")').parents('li').addClass('active');
</script>
